interface FastMarkProps {
  size?: number
  className?: string
}

/** Losango da marca FAST (apenas o ícone, recortado do logo oficial),
 *  usado no menu lateral e em cabeçalhos compactos. */
export function FastMark({ size = 26, className }: FastMarkProps) {
  return (
    <svg
      viewBox="0 0 123 120"
      width={size}
